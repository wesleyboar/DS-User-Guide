...
<strong>If you have any issues using DesignSafe's JupyterHub, </strong><strong>please create a ticket (<a href="https://designsafe-ci.org/help">https://designsafe-ci.org/help</a>)</strong>.
