...
<a name="Fig1"></a> <img src="img/Figure1_viz.jpg" 
     style="display: block;
            max-width: 65%;
            height: auto;
            margin: auto;"/>
...
<a name="Fig2"></a> <img src="img/Figure2_viz.jpg" 
     style="display: block;
            max-width: 85%;
            height: auto;
            margin: auto;"/>
...
<a name="Fig3"></a> <img src="img/Figure3_viz.jpg" 
     style="display: block;
            max-width: 85%;
            height: auto;
            margin: auto;"/>
...
<table>
    <tr>
        <th style="background-color:#FFFFFF;"> <img src="img/Figure4_viz.jpg" style="display: block; max-width: 70%; height: auto; margin: auto;"/> </th>
